...
namespace BillSoft.Infrastructure.Migrations
{
    ...
    [Migration("20260613132158_ReceiptPrintAuditFoundation")]
    partial class ReceiptPrintAuditFoundation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BillSoft.Domain.Cashiering.CashierShift", b =>
                {
                    ...
                    b.HasIndex("RestaurantId", "BranchId")
                        .IsUnique()
                        .HasDatabaseName("UX_CashierShifts_RestaurantId_BranchId_Open")
